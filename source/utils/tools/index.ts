...
export const mathCalculatorTool = tool(mathCalculator, {
...
export const createFileTool = tool(createFile, {
	name: 'create_file',
...
export const fileSearchTool = tool(fileSearch, {
	name: 'file_search',
...
export const pwdTool = tool(pwd, {
	name: 'pwd',
	description: 'Get the current working directory',
	schema: z.object({}),
});

export const terminalCommandTool = tool(terminalCommand, {
